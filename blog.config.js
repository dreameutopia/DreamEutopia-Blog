...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI Spring运维面板', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dreameutopia.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, Spring运维面板', // 网站关键词 英文逗号隔开
